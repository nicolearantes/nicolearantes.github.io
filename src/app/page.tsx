        ...
        <section className={style.midSection}>
          ...
          <section className={style.websiteIntro}>
            <div className={style.aboutWebsite}>
              ...
              <p>
                This website was created with love by me, inspired by the latest
                90s and 2000 websites aesthetic. It´s under construction cause I
                plan to add new features, develop some quizz games and more. I
                hope you like and keep uo to date!
              </p>
            </div>
            <div>
